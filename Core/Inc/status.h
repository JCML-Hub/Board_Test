...
#ifndef BOARD_TEST_STATUS_H
#define BOARD_TEST_STATUS_H
//
...
/// 系统是否已经进入场地
#define STATUS_ENTERED_MASK 0x0000000000040000
#define STATUS_ENTERED 0x0000000000040000

/// 小车当前的朝向，共有四种朝向。
#define STATUS_DIRECTION_MASK 0x0000000000180000
#define STATUS_DIRECTION_OFFSET 19
#define STATUS_DIRECTION(x) ((uint64_t)(x) << STATUS_DIRECTION_OFFSET)

/// 指定系统准备前往的目标点，仅在自动探索模式下有效。目标点共有25个
#define STATUS_TARGET_MASK 0x0000000003E00000
#define STATUS_TARGET_OFFSET 21
#define STATUS_TARGET(x) ((uint64_t)(x) << STATUS_TARGET_OFFSET)

/// 系统是否需要大于一步以上的移动，如果需要，则需要多次执行移动指令。
#define STATUS_MULTI_STEP_MASK 0x0000000004000000
#define STATUS_MULTI_STEP 0x0000000004000000

///系统是否需要先转弯再移动
#define STATUS_TURN_FIRST_MASK 0x0000000008000000
#define STATUS_TURN_FIRST 0x0000000008000000

///findTargetWithMap函数promoter
#define STATUS_FIND_TARGET_WITH_MAP_MASK 0x0000000010000000
#define STATUS_FIND_TARGET_WITH_MAP 0x0000000010000000

/// 系统到达出口区块时，是否从出口走出去
#define STATUS_EXIT_WALK_OUT_MASK 0x0000000020000000
#define STATUS_EXIT_WALK_OUT 0x0000000020000000


#endif //BOARD_TEST_STATUS_H
